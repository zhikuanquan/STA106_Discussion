...
\begin{center}
   \framebox{
    ...
    \hbox to 6.28in { {\bf STA 106B: Applied Statistical Methods - Analysis of Variance
       ...
       \vspace{2mm}
       \hbox to 6.28in { {\it \hfill TA: Zhikuan Quan, zkquan@ucdavis.edu \hfill} }
       \vspace{1mm}
       \hbox to 6.28in { {\it \hfill \href{https://ucdavis.zoom.us/j/2478285521}{Office Hour: Thursday 4:30 pm - 6:30 pm} \hfill} }
       }
   }
\end{center}
...
\begin{itemize}
	...
	\begin{enumerate}
		\item \textbf{Environment, History, Build, VCS}: This window lists all Variables, Data, and Functions defined by us.
